...
%\item If
%\begin{align}
%V_i=E\sbrak{g\brak{\vec{X}_n} |\vec{X}_i}-E\sbrak{g\brak{\vec{X}_{n}}\vert\vec{X}_{i-1}}
%\end{align}
%and
%\begin{align}
%V=g\brak{\vec{X}_n}-E\sbrak{g\brak{\vec{X}_n}}
%\end{align}
%show that
%\begin{align}
%V=\sum_{i=1}V_i
...
%\item Let
%\begin{align}
%L_i&=\inf_{x}\sbrak{E\sbrak{g\brak{\vec{X}_n} |\vec{X}_i,x}-E\sbrak{g\brak{\vec{X}_{n}}\vert\vec{X}_{i-1}}}
%\\
%U_i&=\inf_{x^{\prime}}\sbrak{E\sbrak{g\brak{\vec{X}_n} |\vec{X}_i,x^{\prime}}-E\sbrak{g\brak{\vec{X}_{n}}\vert\vec{X}_{i-1}}}
%\end{align}
%
