...
\item For r.v $X \ge 0$ and $\varepsilon> 0$
\begin{align}
\Pr\brak{X \geqslant \varepsilon} \leqslant\frac{E\sbrak{X}}{\varepsilon}
 \end{align}
\begin{align}
E{x}=\int_{0}^{\infty} \Pr(x\geqslant t)dt
\end{align}
\begin{align}
=\int_{0}^{\infty} \int_{t}^{\infty}f_x(x) d_x dt
\end{align}
\begin{align}
...
\end{enumerate}
%
\section{discretc case:}
$ x=n n\epsilon IN, \Pr(n)$\\
\begin{align}
E[x]=\Sigma_{n=1}^{\infty}n.\Pr(n)=1. \Pr(1)+2p(2).... 
\end{align}
n=1 $\Updownarrow$ $\rightarrow$ $p(x\geqslant1)$

\begin{align}
=1.\Pr(1)+1.\Pr(2)....\\
\end{align}
\begin{align}
=\Sigma_{m=0}^{\infty} \Pr(x\geqslant m)\\
\end{align}
E[x]=$\int_{-\infty}^{\infty} x f_x(\lambda)dx$=$\int_{0}^{\infty} x.f_x(\lambda)dx(\therefore x\geqslant 0)$\\
\begin{align}
=\int_{0}^{\varepsilon} x.f_x(\lambda).dx.+\int_{\varepsilon}^{\infty}x.f_x(\lambda)dx
\end{align}
\begin{align}
\geqslant \int_{\varepsilon}^{\infty}x.f_x(\lambda)dx
\end{align}
\begin{align}
\geqslant \int_{\varepsilon}^{\infty}\varepsilon.f_x(\lambda)dx
\end{align}
 (since x is non negetive)\\
 \begin{align}
=\varepsilon \int_{\varepsilon}^{\infty} f_x (\lambda)dx
\end{align}
\begin{align}
=\varepsilon.\Pr(x\geqslant \varepsilon)
\end{align}
\begin{align}
i.e E[X] \geqslant \varepsilon. \Pr(x\geqslant \varepsilon)
\end{align}
\begin{align}
Or \Pr(x\geqslant\varepsilon)\leqslant \frac{E{X}}{\varepsilon};\varepsilon>0
\end{align}
                                                                                                                                                                                                                                                                       \section{Chebysher ineqnality:} 
For any random variable x,and for any $\varepsilon$ $>0$,\\
\begin{align}
 \Pr[1x-E[x]|\geqslant\varepsilon]\leqslant \frac{Var(x)}{\varepsilon^2}
 \end{align}
if $\phi(\lambda)$ is stricthy monitrmic and incaring,\\
\begin{align} 
 \Pr(x \geqslant\varepsilon)=\Pr(\phi(x)\geqslant \phi(\varepsilon)).
 \end{align}
using this result and lelting\\
\begin{align}
 Y=|x-E[x]|
 \end{align}
$\Pr(y\geqslant\varepsilon)= \Pr(\phi(Y)\geqslant\phi(c))$ Where $\phi(\lambda)=x^2,$\\
\begin{align}
=\Pr[(x-E[x])^2\geqslant \varepsilon^2]
\end{align}
Cheorrly $\phi(y)$ is non-negative and the $\mu$I is Valid.\\
\begin{align}
\Rightarrow \Pr(y\geqslant\varepsilon)\leqslant \frac{E{(x-E{x})}}{\varepsilon^2}
\end{align}
